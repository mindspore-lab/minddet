...
from det3d_ms.datasets.custom import PointCloudDataset
from det3d_ms.datasets.nuscenes.nusc_common import (
...
from det3d_ms.datasets.registry import DATASETS
    ...
    def __getitem__(self, idx):
        ...
        if self.test_mode:
            return (
                ...
                data["num_voxels"],
                data["shape"],
                [ord(i) for i in data["metadata"]["token"]],
            )
        else:
            return (
                data["voxels"],
