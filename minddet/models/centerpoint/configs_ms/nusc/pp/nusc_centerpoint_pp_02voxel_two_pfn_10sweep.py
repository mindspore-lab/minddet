...
from det3d_ms.utils.config_tool import get_downsample_factor
...
resume_from = None
workflow = [("train", 1)]
train_mindrecord_dir = "/data/train/ptcloud.mindrecord00"
test_mindrecord_dir = "/data/test/ptcloud.mindrecord00"
