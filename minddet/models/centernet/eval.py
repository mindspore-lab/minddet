...
from src import convert_eval_format, post_process, merge_outputs, CenterNetDetEval
...
def predict():
    ...
    param_not_load, ckpt_not_load = load_param_into_net(net_for_eval.network, param_dict)
